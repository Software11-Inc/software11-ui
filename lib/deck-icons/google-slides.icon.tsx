...
export const GoogleSlidesIcon: React.FC<{
  width?: number;
  height?: number;
}> = ({ width = 16, height = 16 }) => {
  return (
    ...
    >
      <defs>
        <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="200291" y1="94137" x2="200291" y2="173145">
          <stop offset="0" stop-color="#bf360c" />
          <stop offset="1" stop-color="#bf360c" />
        </linearGradient>
        <mask id="b">
          <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="200291" y1="91174.4" x2="200291" y2="176107">
      ...
      <g fill-rule="nonzero">
        ...
        <path
          ...
          fill="#f0f0f0"
        />
        <path mask="url(#b)" fill="url(#c)" d="M158158 84261l84266 84242V90909z" />
        <path d="M151516 0v68181c0 12557 10167 22728 22726 22728h68182L151515 0z" fill="#f9da80" />
        <path fill="#fff" fill-opacity=".102" d="M151516 0v1893l89008 89016h1900z" />
        <path
